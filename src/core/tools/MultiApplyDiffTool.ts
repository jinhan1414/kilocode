...
export async function applyDiffTool(
	...
	// Determine tool protocol (native vs xml). Handler below supports both.
	...
	if (provider && state) {
		...
		// If experiment is disabled, fall back to legacy single-file handling below.
	}

	// Continue with multi-file implementation (also supports legacy params)
